...
export const experiences = [
  {
    ...
    desc: [
      "Developed a scalable spiritual services platform for online and on-site Pooja bookings using Next.js and NestJS, implementing optimized REST API caching for faster response times.",
      "Architected a microservices-based backend with Kafka for real-time event-driven communication, improving system responsiveness by 40%.",
      "Built a secure admin dashboard with JWT authentication and Role-Based Access Control (RBAC).",
      "Spearheaded a modern, responsive UI with Material-UI (MUI) and TypeScript, enhancing code stability and user experience.",
      "Deployed backend services on AWS Elastic Beanstalk and frontend on AWS Amplify with Nginx for reverse proxying, increasing reliability by 20%.",
      ...
      "Optimized caching strategies with Redis and fine-tuned database queries, cutting API response times by 50%.",
      "Developed an AI Interview Module with generative AI and automated testing workflows using GitHub Actions.",
      "Applied caching optimizations in Next.js and deployed production on AWS with S3 and CloudFront.",
    ],
    skills: [
      "Nest Js",
      "Next Js",
