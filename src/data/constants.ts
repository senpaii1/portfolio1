export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1valQ38cL3Hxw4fdX0_La2p3PQGBEZ6dT/view?usp=sharing",
...
export const experiences = [
  {
    ...
    desc: "Developed a scalable spiritual services platform for online and on-site Pooja bookings using Next.js and NestJS, implementing optimized REST API caching for faster response times. Architected a microservices-based backend with Kafka for real-time event-driven communication, improving system responsiveness by 40%. Built a secure admin dashboard with JWT authentication and Role-Based Access Control (RBAC). Spearheaded a modern, responsive UI with Material-UI (MUI) and TypeScript, enhancing code stability and user experience. Deployed backend services on AWS Elastic Beanstalk and frontend on AWS Amplify with Nginx for reverse proxying, increasing reliability by 20%. Implemented an automated CI/CD pipeline using AWS CodePipeline and S3, reducing deployment time by 40% with zero downtime updates. Optimized caching strategies with Redis and fine-tuned database queries, cutting API response times by 50%. Developed an AI Interview Module with generative AI and automated testing workflows using GitHub Actions. Applied caching optimizations in Next.js and deployed production on AWS with S3 and CloudFront.",
    skills: [
      "Nest Js",
      "Next Js",
      "JavaScript",
  ...
  },
  {
    ...
    desc: "Revamped AI-driven services, improving efficiency and aligning with business needs. Led a team in API optimization, achieving a 60% reduction in load times through improved indexing and caching strategies. Designed and integrated a high-performance Python-based microservice for real-time image processing using Azure Functions and Azure Cognitive Services. The service, deployed in an Azure-hosted Docker container, accelerated processing speed by 70% and seamlessly communicated with the Node.js backend. Mentored junior developers, conducted regular code reviews, and organized training sessions, resulting in a 20% improvement in development speed. Deployed backend services on Azure and implemented Docker-based pipelines, streamlining releases and reducing deployment time. Built and deployed frontend applications on Firebase, ensuring high performance and security. Leveraged Azure web services, logic apps, function apps, and storage accounts to create scalable and reliable cloud applications.",
    skills: [
      "React Js",
      "Redux",
      "Node Js",
